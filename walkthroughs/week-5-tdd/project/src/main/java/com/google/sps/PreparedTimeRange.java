...
/**
 * PreparedTimeRange class is used to store the open time slots after computation as well
 * as a boolean indicator to tell whether there are any available open times
 */
public final class PreparedTimeRange {
   ...
   */
  public PreparedTimeRange(List<TimeRange> openTimes) {
